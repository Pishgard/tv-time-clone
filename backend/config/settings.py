"""
Django settings for tv-time-clone backend.
...
# ---------------------------------------------------------------------------
# Database — SQLite by default, override via DATABASE_URL for Postgres
# ---------------------------------------------------------------------------
...
SPECTACULAR_SETTINGS = {
    "TITLE": "TV Time Clone API",
    "DESCRIPTION": "Track TV shows, episodes, and share with friends.",
    "VERSION": "1.0.0",
